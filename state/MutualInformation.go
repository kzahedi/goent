...
func MI(data [][]int64, log goent.LnFunc) []float64 {

	pxy := goent.Emperical2D(data)
...
// MutualInformation calculates the mutual information with for each state with base 2
