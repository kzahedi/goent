...
// func MC_W(pw2w1a1 [][]int64) []float64 {
...
// // K. Zahedi and N. Ay. Quantifying morphological computation. Entropy, 15(5):1887–1915, 2013.
// // http://www.mdpi.com/1099-4300/15/5/1887 (open access)
// func MC_A(pw2a1w1 [][][]int64) []float64 {
...
// func MC_CW(pw2w1, pw2a1 [][]int64) float64 {
// 	return MutualInformation2(pw2w1) - MutualInformation2(pw2a1)
// }
//
// // MC_WA = I(W;{W,A}) - I(W';A)
// func MC_WA(pw2w1a1 [][][]int64) float64 {
// 	w2Dim := len(pw2w1a1)
// 	w1Dim := len(pw2w1a1[0])
...
//
// // MC_WS = I(W;{W,S}) - I(W';S)
// func MC_WS(pw2w1s1 [][][]int64) float64 {
// 	w2Dim := len(pw2w1s1)
// 	w1Dim := len(pw2w1s1[0])
