...
func MorphologicalComputationW(w2w1a1 [][]float64, w2Indices, w1Indices, a1Indices []int64, k int64) float64 {
	return FrenzelPompe(w2w1a1, w2Indices, w1Indices, a1Indices, k, false)
}

// MorphologicalComputationA [...]
func MorphologicalComputationA(w2a1w1 [][]float64, w2Indices, a1Indices, w1Indices []int64, k int64) float64 {
	return FrenzelPompe(w2a1w1, w2Indices, a1Indices, w1Indices, k, false)
}

// MorphologicalComputationCW1 [...]
func MorphologicalComputationCW1(w2w1a1 [][]float64, w2Indices, w1Indices, a1Indices []int64, k int64) float64 {
...
func MorphologicalComputationCW2(w2w1a1 [][]float64, w2Indices, w1Indices, a1Indices []int64, k int64) float64 {
...
func MorphologicalComputationWA1(w2w1a1 [][]float64, w2Indices, w1Indices, a1Indices []int64, k int64) float64 {
...
func MorphologicalComputationWA(w2w1a1 [][]float64, w2Indices, w1Indices, a1Indices []int64, k int64) float64 {
...
func MorphologicalComputationWS1(w2w1s1 [][]float64, w2Indices, w1Indices, s1Indices []int64, k int64) float64 {
...
func MorphologicalComputationWS2(w2w1s1 [][]float64, w2Indices, w1Indices, s1Indices []int64, k int64) float64 {
...
func MorphologicalComputationMI1(w2w1s1a1 [][]float64, w2Indices, w1Indices, s1Indices, a1Indices []int64, k int64) float64 {
...
func MorphologicalComputationMI2(w2w1s1a1 [][]float64, w2Indices, w1Indices, s1Indices, a1Indices []int64, k int64) float64 {
