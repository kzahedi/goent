...
func TestKraskovStoegbauerGrassberger1IndependentWithBar(t *testing.T) {
	t.Log("Testing KraskovStoegbauerGrassberger1 against independent distribution")
	rand.Seed(1)
	...
	r1 := continuous.KraskovStoegbauerGrassberger1(xy, xIndex, yIndex, 30, true)
	r2 := state.KraskovStoegbauerGrassberger1(xy, xIndex, yIndex, 30, true)
	r3 := 0.0
...
func TestKraskovStoegbauerGrassberger1GaussianWithBar(t *testing.T) {
	t.Log("Testing KraskovStoegbauerGrassberger1 against Gaussian distribution")
	rand.Seed(1)
	...
	r1 := continuous.KraskovStoegbauerGrassberger1(xy, xIndex, yIndex, k, true)
	r2 := state.KraskovStoegbauerGrassberger1(xy, xIndex, yIndex, k, true)
	r3 := 0.0
