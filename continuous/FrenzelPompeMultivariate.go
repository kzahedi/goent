...
func fpCountXY(epsilon float64, xyz []float64, data [][]float64, xIndices, yIndices []int64) (c int64) {
...
// closer than epsilon, where the Distance is measured by the max-norm
func fpCountYZ(epsilon float64, xyz []float64, data [][]float64, yIndices, zIndices []int64) (c int64) {
...
// closer than epsilon
func fpCountZ(epsilon float64, xyz []float64, data [][]float64, zIndices []int64) (c int64) {
	for t := 0; t < len(data); t++ {
